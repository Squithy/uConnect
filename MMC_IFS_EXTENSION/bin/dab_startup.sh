...
/fs/mmc0/app/bin/dev-tuner-dab -p/usr/var/dab/devdab.pers -i/dev/null -u/dev/ser4 -r/dev/gpio/XM_DAB1Reset -s/dev/spi40 -u/dev/ser5 -r/dev/gpio/HD_DAB2Reset -s/dev/spi10 --tp=/fs/mmc0/app/share/trace/dev-tuner-dab.hbtc &
...
/fs/mmc0/app/bin/dabService -d --tp=/fs/mmc0/app/share/trace/dabService.hbtc &
